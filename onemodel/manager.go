...
func (mm *onemodelManager) Client() *jfroghttpclient.JfrogHttpClient {
	return mm.client
}

func (mm *onemodelManager) GraphqlQuery(query []byte) ([]byte, error) {
	onemodelService := services.NewOnemodelService(mm.config.GetServiceDetails(), mm.client)
