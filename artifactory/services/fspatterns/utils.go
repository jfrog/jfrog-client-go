...
func GetRootPath(pattern string, isRegexp, preserveSymLink bool, parentheses utils.ParenthesesSlice) (string, error) {
	rootPath := utils.GetRootPath(pattern, isRegexp, parentheses)
